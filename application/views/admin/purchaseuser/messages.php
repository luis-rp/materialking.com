	  ...
	  <tr>
			...
			if($messages)
			{
				foreach ($messages as $po)
				{
					...
					<h3 class="box-header" style="display:inline;"">Contract:<?php echo $po['quote']['ponum'];?> &nbsp;&nbsp;<a class="btn btn-green" style="font-size:12px;font-weight:normal;" target="_blank" href="<?php echo site_url().'admin/quote/conbids/'.$po['quote']['id'];?>">View Bids Page</a>
					<?php if($po['quote']['awardid']){?> - &nbsp;<a class="btn btn-green" style="font-size:12px;font-weight:normal;" target="_blank" href="<?php echo site_url().'admin/quote/contracttrack/'.$po['quote']['id'] ;?>">View Tracking Page</a	<?php } ?> 
					<?php } else { ?>
				<h3 class="box-header" style="display:inline;"">Contract:<?php echo $po['quote']['ponum'];?> &nbsp;&nbsp;<a class="btn btn-green" style="font-size:12px;font-weight:normal;" target="_blank" href="<?php echo site_url().'admin/quote/invitation/'.$po['quote']['invitation'];?>">View Bids Page</a> <?php if($po['quote']['awardid']){?> - &nbsp;<a class="btn btn-green" style="font-size:12px;font-weight:normal;" target="_blank" href="<?php echo site_url().'admin/quote/trackpurchaser/'.$po['quote']['id'].'/'.$po['quote']['awardid'] ;?>">View Tracking Page</a><?php } ?> 
					<?php } }else {?>
