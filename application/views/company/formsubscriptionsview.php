                   ...
                   <div class="row">
            		<form  class="animated fadeIn" role="form" method="post" action="saveformdata">
 					...
 					<div class="form-group">
    						...
    						<a class="close" href="<?php echo base_url().'company/deleteformsubscriptionsdata/'.$fields->Id;?>" onclick="return confirm('Are you really want to delete this field?');">&times;</a>
    							<div class="controls">
      					<?php if($fields->FieldType == 'text' || $fields->FieldType == 'email' || $fields->FieldType == 'password') {?>
      							<input type="<?php echo $fields->FieldType ?>" class="form-control" id="<?php echo $name_id; ?>" name="<?php echo $fields->Name ?>" placeholder="<?php echo $fields->Label; ?>" required value="<?php echo $fields->Value;?>">
      					<?php  }  ?>
						...
						<?php } ?>
 					    <div class="form-group">
	                        ...
	                        <div class="controls">
	                            <a href="<?php echo base_url() . 'company/mailinglist';?>"><input type="button"  class="btn btn-primary" value="Back"></a>&nbsp;&nbsp;
