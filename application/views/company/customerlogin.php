<div class="container">
  <div class="row login-container animated fadeInUp">  
        <div class="col-md-7 col-md-offset-2 tiles white no-padding">
		 ...
		 <h2 class="normal">Customer Login</h2>
          <h2 class="normal">Login To Your Account</h2>
          <p class="p-b-20 general">Enter Your Username and Password 
    	   <!-- Or <a href="<?php echo site_url('company/register');?>">Create New Account</a>-->
    	  </p>
		...
		<div class="tiles grey p-t-20 p-b-20 text-black">
			  <form id="frm_login" name="frm_login" class="animated fadeIn" method="post" action="<?php echo site_url('company/checkcustomerlogin');?>">
