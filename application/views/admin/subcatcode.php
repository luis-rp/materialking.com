...
<section class="row-fluid">
	...
	<div class="box">
		...
		<form class="form-horizontal" method="post" action="<?php echo $action; ?>"> 
                    ...
                    <br/>
		   <a class="btn btn-green" href="<?php echo site_url('admin/subcatcode');?>">&lt;&lt; Back</a>
		   <br/>
		   ...
		   <input type="hidden" name="id" value="<?php echo $this->validation->id;?>"/>
		    ...
		    <div class="control-group">
                        ...
                        <div class="controls">
                          ...
                          <?php echo $this->validation->category_error;?>
                        </div>
                        </div>
		    ...
		    <div class="controls">
		      <input type="text" id="subcategory" name="subcategory" class="span7" value="<?php echo $this->validation->subcategory; ?>">
		      <?php echo $this->validation->subcategory_error;?>
		    </div>
		    </div>
