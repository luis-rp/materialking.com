...
<?php //print_r($items);die;?>
    <div class="content">  
		...
		<div class="page-title">
			...
			<h3>Inventory <a href="<?php echo site_url('inventory/export'); ?>" class="btn btn-primary btn-xs btn-mini">Export</a> &nbsp;&nbsp;<a href="<?php echo site_url('inventory/inventoryPDF'); ?>" class="btn btn-primary btn-xs btn-mini">View PDF</a> 	<span style="float:right; margin:0px 9px 0px 0px"><a href="#" class="btn btn-primary btn-xs btn-mini">Go to my store</a></span></h3>
