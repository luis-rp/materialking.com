                              ...
                              <tr>
                                 ...
                                 <td>
                                      ...
                                      <?php if($item->featureditem->price){?>
                                       ...
                                       <?php }else{?>
                                    	<a class="btn btn-primary" href="javascript:void(o)" onclick="addtocart(<?php echo $item->id; ?>, <?php echo $item->featuredsupplier; ?>, <?php echo $item->featureditem->ea ? $item->featureditem->ea : 0; ?>,<?php echo (isset($item->featureditem->minqty))?$item->featureditem->minqty:'1';?>,'<?php echo $item->unit ? $item->unit : '';?>','<?php echo htmlspecialchars($item->itemcode);?>', '<?php echo htmlspecialchars($item->itemname);?>')">
                            ...
                            <table id="datatable newtable" class="table table-bordered smallfont ">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:0px;" align="center">
                                       ...
                                       <?php }else{?>
                                    	<a class="btn btn-primary" href="javascript:void(0)" onclick="addtocart(<?php echo $inv->itemid; ?>, <?php echo $inv->company; ?>, <?php echo $inv->ea; ?>, <?php echo $inv->minqty; ?>,'<?php echo $inv->unit ? $inv->unit : '';?>','<?php echo htmlspecialchars($inv->itemcode);?>', '<?php echo htmlspecialchars($inv->itemname);?>')">
