                                ...
                                <div class="property span9">
                                    <div class="row">
                                        ...
                                        <div class="body_home span6">
                                            ...
                                            <p><div class="link"><a href="<?php echo site_url('site/supplier/' . $supplier->username); ?>">View Profile</a></div><div class="link"><a href="<?php echo site_url('store/items/' . $supplier->username); ?>">Go to Store</a></div><?php //echo $supplier->shortdetail; ?></p>
                                            <div class="area">
