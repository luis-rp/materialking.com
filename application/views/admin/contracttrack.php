...
<?php //var_dump($awarded); exit;  ?>
    <div class="box">
        <div class="span12">
            ...
            &nbsp;&nbsp;<a href="<?php echo site_url('admin/quote/contracttrackexport').'/'.$adquoteid; ?>" class="btn btn-green">Export</a>&nbsp;&nbsp;<a href="<?php echo site_url('admin/quote/contracttrackpdf').'/'.$adquoteid; ?>" class="btn btn-green">View PDF</a>
            <br/> <br/>
                ...
                <table class="table table-bordered">
                    <tr>
					    ...
					    <?php $alltotal+=$q->totalprice; ?>
                            <tr>
                                <td><?php echo @$q->companydetails->companyname; ?></td>
                                <td><?php if(@$q->attach && file_exists("./uploads/quote/".$q->attach)){?>
				                        	<br>
           ...
           <table class="table table-bordered" >
            ...
            if (@$messages)
                foreach ($messages as $c)
                    if (@$c['messages']) {
                        ?>
                         <h3 class="box-header">Messages for <?php echo $c['companydetails']->companyname ?> regarding PO# <?php echo $quote->ponum; ?>:</h3>
                        <table class="table table-bordered" >
                            <tr>
                                <th>From</th>
                                <th>To</th>
                ...
                <div class="well" style="float:left">
                    <form class="form-horizontal" method="post" action="<?php echo site_url('admin/message/sendcontractmessage/' . $quote->id . '/contracttrack') ?>" onsubmit="this.to.value = this.company.options[this.company.selectedIndex].innerHTML"  enctype="multipart/form-data">
