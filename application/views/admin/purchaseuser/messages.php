	...
	<div class="box">
	  ...
	  <tr>
	  		<td><strong>Search PO Number</strong></td>
	   		<td><input type="text" name="ponumsearch" id="ponumsearch" style="width:240px;" class="input" value="<?php echo $ponumsearch;?>"> </td>
	   		<td><strong>Search Message</strong></td>
	   		<td><input type="text" name="searchmsg" id="searchmsg" style="width:240px;;" class="input" value="<?php echo $searchmsg;?>"> </td>
	   		<td><strong>Sort By </strong></td>
	  		<td>
	   			<select name="sortby" id="sortby" style="width:100px;">
	   			<option value="date" <?php if($sortbyoption =='date') echo " selected ";else echo ''?> >Date</option>
	   			<option value="ponumber" <?php if($sortbyoption =='ponumber') echo " selected ";else echo ''?>>PO Number</option>	   			
	   			<option value="company" <?php if($sortbyoption =='company') echo " selected ";else echo ''?>>Company</option>
	   			</select>
	   		</td> 	 
