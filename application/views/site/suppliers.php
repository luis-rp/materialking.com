                        ...
                        <div class="row">
                            ...
                            <?php if ($norecords) { ?>
                                <div class="alert alert-error" style="margin-left:30px;">
                                    ...
                                    <strong> <?php echo $norecords; ?></strong> <a href="<?php echo site_url('site/suppliers'); ?>">View All Listing</a>
                                </div>
                            <?php } ?>
                                ...
                                <div class="property span9" style="width:auto">
                                    <div class="row">
                                        ...
                                        <div class="body1 span6">
                                            ...
                                            <?php }?>
                                            <div class="link"><a href="<?php echo site_url('site/supplier/' . $supplier->username); ?>">View Profile</a></div><div class="link"><a href="<?php echo site_url('store/items/' . $supplier->username); ?>">Go to Store</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
