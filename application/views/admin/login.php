...
<head>
	...
	<script type="text/javascript">
		...
		document.write('<link href="<?php echo base_url(); ?>assets/css/' + DEMO_ADMINFLARE_VERSION + '/' + DEMO_CURRENT_THEME + '/bootstrap.min.css" media="all" rel="stylesheet" type="text/css" id="bootstrap-css">');
		// Include AdminFlare stylesheet 
		document.write('<link href="<?php echo base_url(); ?>assets/css/' + DEMO_ADMINFLARE_VERSION + '/' + DEMO_CURRENT_THEME + '/adminflare.min.css" media="all" rel="stylesheet" type="text/css" id="adminflare-css">');
	</script>
	
	<script src="<?php echo base_url(); ?>assets/javascripts/1.2.3/modernizr-jquery.min.js" type="text/javascript"></script>
	<script src="<?php echo base_url(); ?>assets/javascripts/1.2.3/adminflare-demo.min.js" type="text/javascript"></script>
...
<body>
	...
	<section class="signin-container">
		...
		<?php echo form_open('index.php/admin/login/process_login') . "\n"; ?>
			<fieldset>
				<div class="fields">
				...
				<a class="btn btn-primary btn-block" href="<?php echo site_url('index.php/admin/register/forgot');?>">Forgot Username/Password</a>
				
				<a class="btn btn-primary btn-block" href="<?php echo site_url('index.php/admin/register');?>">Register Now</a>
